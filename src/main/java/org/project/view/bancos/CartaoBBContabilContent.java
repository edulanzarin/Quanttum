...
import org.project.functions.bancos.CartaoBBContabil;

import java.io.*;
import java.util.List;

public class CartaoBBContabilContent extends VBox {

    private TextField filePathField;
    private TableView<Transaction> tableView;
    private File selectedFile;

    public CartaoBBContabilContent(Stage primaryStage) {
        ...
        // Título
        Label titleLabel = new Label("Cartão BB Contábil");
    ...
    private void processFile(Stage primaryStage) {
        ...
        try {
            ...
            List<CartaoBBContabil.RegistroCartaoBB> registros = CartaoBBContabil.processCartaoBB(selectedFile);

            // Limpar a tabela antes de adicionar novos dados
            tableView.getItems().clear();

            // Adicionar os dados processados à tabela
            for (CartaoBBContabil.RegistroCartaoBB registro : registros) {
